...
class _HomePageState extends ConsumerState<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    // Fallback/Mock values to populate the Skeletonizer layout while loading
    final dashboardData = dashboardAsync.value ?? const DashboardData(
      todaySales: 145200,
      todayExpenses: 12500,
      soldProducts: [
        SoldProductItem(
          productName: 'Nirvana Bottled water',
          quantitySold: 4,
          salesAmount: 6000,
        ),
        SoldProductItem(
          productName: 'Goldberg Bottle',
          quantitySold: 2,
          salesAmount: 18200,
        ),
      ],
        ...
        child: RefreshIndicator(
          ...
          child: SingleChildScrollView(
            ...
            child: Padding(
              ...
              child: Skeletonizer(
                enabled: dashboardAsync.isLoading || dashboardAsync.isRefreshing,
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: const Color(0xFFE2E8F0), // Light slate container background
                    ...
                    AnimatedSwitcher(
                      ...
                      child: _selectedTabIndex == 0
                          ...
                          : SoldProductsSection(items: dashboardData.soldProducts),
                    ),
                  ],
                ),
              ),
